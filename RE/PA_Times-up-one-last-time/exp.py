...
mid44 = cal(
    solver.solve(line1, 0, 13), solver.solve(line1, 0, 14), solver.solve(line1, 1, 13)
)

mid4 = cal(solver.solve(line1, 0, 12), mid44, solver.solve(line1, 1, 12))

mid5 = cal(
    solver.solve(line1, 0, 15), solver.solve(line1, 0, 16), solver.solve(line1, 1, 15)
)
mid6 = cal(mid4, mid5, solver.solve(line1, 1, 14))
