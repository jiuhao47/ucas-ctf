            ...
            if event.type == pygame.MOUSEBUTTONUP:
                ...
                if 550 <= mouse[0] <= 550 + 170 and 250 <= mouse[1] <= 250 + 50:
                    ...
                    if rnd == 0:
                        put_script(
                            ...
                            screen,
                            "System",
                            f"Server connection broken.. bye..",
                            1,
                        )
                        exit()
                    ...
                    put_script(
                        ...
                        screen,
                        character.nickname,
                        random.choice(messages.EAT_MESSAGE),
                        1,
                    )
                ...
                # Pwn
                    ...
                    if character.stamina >= 10:
                        ...
                        put_script(
                            ...
                            screen,
                            character.nickname,
                            random.choice(messages.PWN_SUCCESS_MESSAGE),
                            1,
                        )
                        put_script(
                            font, screen, "System", f"stamina -10, intelligence +{rnd}"
                        )
                        ...
                        put_script(
                            ...
                            screen,
                            character.nickname,
                            random.choice(messages.PWN_FAIL_MESSAGE),
                            1,
                        )
                ...
                # Sleep
                    ...
                    put_script(
                        ...
                        screen,
                        character.nickname,
                        random.choice(messages.SLEEP_MESSAGE),
                        1,
                    )
                    put_script(font, screen, "System", f"stamina +{rnd}")
                    put_character_status(font, screen, character)
                ...
                # Date
                    ...
                    put_script(
                        ...
                        screen,
                        character.nickname,
                        messages.DATE_REQUEST_MESSAGE[min(character.friendship, 33)],
                        1,
                    )
                    if (
                        character.stamina >= 10
                        and character.intelligence.bit_length() >= character.friendship
                    ):
                        character.stamina -= 10
                        ...
                        if character.friendship == 34:
                            ...
                            put_script(
                                ...
                                screen,
                                "Cogechan",
                                random.choice(messages.DATE_SUCCESS_MESSAGE),
                                1,
                            )
                            put_script(
                                font, screen, "System", f"stamina -10, friendship +1"
                            )
                        ...
                        put_script(
                            ...
                            screen,
                            "Cogechan",
                            random.choice(messages.DATE_FAIL_MESSAGE),
                            1,
                        )
