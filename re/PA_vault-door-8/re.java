...
class VaultDoor8 {
    public static void main(String args[]) {
        ...
        String c = b.next();
        String f = c.substring("NeSE{".length(), c.length() - 1);
    ...
    public char[] scramble_re(char[] a) {/* Scramble a password by transposing pairs of bits. */
        char[] s = a;
        for (int b = 0; b < a.length; b++) {
            char c = s[b];
            c = switchBits(c, 6, 7);
    ...
    public boolean checkPassword(String password) {
        ...
        char[] re = scramble_re(expected);
        System.out.println(re);
        return Arrays.equals(scrambled, expected);
    }
}

// 在原java程序的基础上改出来的，虽然没有理解为啥源程序过不了
// 二编，在恢复源程序后通过了，只能说，得学JAVA